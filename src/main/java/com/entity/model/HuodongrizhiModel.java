 ...
 */
public class HuodongrizhiModel  implements Serializable {
	...
	public void setHuodongjingli(String huodongjingli) {
		this.huodongjingli = huodongjingli;
	}
	
	/**
	 * 获取：活动经历
	 */
	public String getHuodongjingli() {
		return huodongjingli;
	}
