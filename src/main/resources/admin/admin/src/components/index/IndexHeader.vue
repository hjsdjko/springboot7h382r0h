<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","order":"3"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","color":"#fff","background":"linear-gradient(90deg, rgba(203,237,255,1) 0%, rgba(132,251,255,1) 50%, rgba(184,223,166,1) 100%)","-webkitTextFillColor":"transparent","lineHeight":"44px","fontSize":"28px","float":"left","fontWeight":"600","-webkitBackgroundClip":"text"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"absolute","color":"inherit","left":"30px","display":"inline-block"}'>
