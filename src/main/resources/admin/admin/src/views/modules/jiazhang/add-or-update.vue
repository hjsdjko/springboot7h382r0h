	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="学生性别" prop="xueshengxingbie">
					<el-select :disabled="ro.xueshengxingbie" v-model="ruleForm.xueshengxingbie" placeholder="请选择学生性别" >
						<el-option
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="学生性别" prop="xueshengxingbie">
					<el-input v-model="ruleForm.xueshengxingbie"
						placeholder="学生性别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="年级" prop="nianji">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="是否会员" prop="vip">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="是否会员" prop="vip">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.nianjiOptions = "一年级,二年级,三年级,四年级,五年级,六年级".split(',')
    ...
    onSubmit() {
      ...
      if((this.ruleForm.mima.length<2)){
        this.$message.error(`密码长度不能小于2`);
        return
      }
