<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'" label="书籍编号" prop="shujibianhao">
					<el-input v-model="ruleForm.shujibianhao" placeholder="书籍编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.shujibianhao" label="书籍编号" prop="shujibianhao">
					<el-input v-model="ruleForm.shujibianhao" placeholder="书籍编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="书籍名称" prop="shujimingcheng">
					<el-input  v-model="ruleForm.shujimingcheng" placeholder="书籍名称" clearable  :readonly="ro.shujimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="书籍名称" prop="shujimingcheng">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="书籍类型" prop="shujileixing">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="书籍类型" prop="shujileixing">
					<el-input v-model="ruleForm.shujileixing"
						placeholder="书籍类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="作者" prop="zuozhe">
					<el-input  v-model="ruleForm.zuozhe" placeholder="作者" clearable  :readonly="ro.zuozhe"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="作者" prop="zuozhe">
					<el-input v-model="ruleForm.zuozhe" placeholder="作者" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="出版时间" prop="chubanshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.chubanshijian" 
						type="date"
						:readonly="ro.chubanshijian"
						placeholder="出版时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.chubanshijian" label="出版时间" prop="chubanshijian">
					<el-input v-model="ruleForm.chubanshijian" placeholder="出版时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="出版社" prop="chubanshe">
					<el-input  v-model="ruleForm.chubanshe" placeholder="出版社" clearable  :readonly="ro.chubanshe"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="出版社" prop="chubanshe">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="图书简介" prop="tushujianjie">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.tushujianjie" label="图书简介" prop="tushujianjie">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.tushujianjie"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='shujibianhao'){
							this.ruleForm.shujibianhao = obj[o];
							this.ro.shujibianhao = true;
							continue;
						}
						if(o=='shujimingcheng'){
            ...
            this.$http({
				url: `option/shujifenlei/shujileixing`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushujianjie = this.ruleForm.tushujianjie.replace(reg,'../../../springboot7h382r0h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.shujibianhao) {
			this.ruleForm.shujibianhao = String(this.ruleForm.shujibianhao)
		}
