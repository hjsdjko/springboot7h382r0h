<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="书籍类型" prop="shujileixing">
					<el-input  v-model="ruleForm.shujileixing" placeholder="书籍类型" clearable  :readonly="ro.shujileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="书籍类型" prop="shujileixing">
					<el-input v-model="ruleForm.shujileixing" placeholder="书籍类型" readonly></el-input>
				</el-form-item>
			</template>
